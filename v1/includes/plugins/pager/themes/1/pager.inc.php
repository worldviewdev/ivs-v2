...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    ...
    <td  width="28%" align="center" nowrap><?php if($this->has_previous()) {?><a href="<?=$this->previous_page?>" class="pager_link">&laquo; Previous <?=$this->records_per_page?></a> <?php }?></td>
	<td  width="14%" align="center" nowrap>
	<?php if($this->has_next()) {?><a href="<?=$this->next_page?>" class="pager_link">Next <?
