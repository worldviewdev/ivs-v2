				...
				<td height="20" align="left" valign="top" class="paging_rounded_inner_bg">
					<table width="100%" border="0" cellspacing="0" cellpadding="5">
					  <tr>
						...
						<span class="txtorange14">Showing Records:</span> <span class="txtblack14"><?= $this->start+1?> - <?=min($this->total_records, $this->start+$this->records_per_page)?> of <?= $this->total_records?></span></td>
						<td width="85%" align="right" valign="middle" class="paging">
						<?php if($this->has_previous()) {?>
							<a href="<?=$this->previous_page?>" class="pager_link">&laquo; Previous</a>
						<?php }
						...
						if($this->has_next()) {
						?>
						<a href="<?=$this->next_page?>">Next &raquo;</a>
						<?php }?>
						</td>
					  </tr>
					</table>
