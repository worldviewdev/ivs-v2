...
<script>
    ...
    // Initialize DataTable for Paid in Full Files using reusable component
    const paidInFullFilesTable = createDataTable('files', {
        ajax: {
    ...
    if (flatpickrElement) {
        const flatpickr = $(flatpickrElement).flatpickr({
            ...
            onChange: function (selectedDates, dateStr, instance) {
                ...
                if (paidInFullFilesTable) {
                    paidInFullFilesTable.refresh();
                }
            },
        });
