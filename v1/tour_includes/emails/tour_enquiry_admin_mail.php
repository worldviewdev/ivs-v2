<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td>A new <?=$etype?> has been added to the order log:</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
  ...
  <tr>
    <td><a href="http://www.toursitalia.com/<?=ADMIN_DIR?>/enquiry_log.php" target="_blank">Click here to see full details.</a></td>
  </tr>
</table>